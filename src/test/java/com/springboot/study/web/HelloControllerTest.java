...
@WebMvcTest(controllers = HelloController.class) // 여러 스프링 테스트 어노테이션 중 Web(Spring MVC)에 집중할 수 있는 어노테이션으로, 선언 시 @Controller, @ControllerAdvice 등 사용가능 -> 여기서는 컨트롤러만 사용하므로 선언
